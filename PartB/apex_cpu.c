    ...
    if (cpu->decode.has_insn)
    {
        ...
        case OPCODE_CMP:
        {
            ...
            { 
                ...
                if ((strcmp(cpu->execute.opcode_str, "LOAD") == 0 || strcmp(cpu->execute.opcode_str, "LDR") == 0) 
                && cpu->execute.rd == cpu->decode.rs1)
                {
